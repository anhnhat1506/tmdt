...
<head>
    ...
    <!-- iCheck -->
    <link href="<?=THEME_ROOT?>/theme/vendors/iCheck/skins/flat/green.css" rel="stylesheet">

    <!-- bootstrap-progressbar -->
    <link href="<?=THEME_ROOT?>/theme/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="<?=THEME_ROOT?>/theme/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="<?=THEME_ROOT?>/theme/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
